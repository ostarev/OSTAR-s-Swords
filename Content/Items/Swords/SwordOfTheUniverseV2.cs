...
public class SwordOfTheUniverseV2 : ModItem
{
	...
	public override void AddRecipes()
	{
		...
		recipe.AddIngredient(Mod, "TrueHorrormageddon", 1);
		recipe.AddIngredient(Mod, "PrismSword", 1);
		recipe.AddIngredient(Mod, "EdgeLord", 1);
		recipe.AddIngredient(Mod, "SuperInflation", 1);
		recipe.AddIngredient(Mod, "CosmoStorm", 1);
		recipe.AddIngredient(Mod, "GlacialCracker", 1);
		...
		recipe7.AddIngredient(Mod, "SwordOfTheUniverseV6", 1);
		recipe7.Register();
		Recipe recipe8 = CreateRecipe();
		recipe8.AddIngredient(Mod, "SwordOfTheUniverseV7", 1);
		recipe8.Register();
		Recipe recipe9 = CreateRecipe();
		recipe9.AddIngredient(Mod, "SwordOfTheUniverseV8", 1);
		recipe9.Register();
	}
